...
Iter_t is_stable_sorted_forward (Iter_t first, Iter_t last,
...
//-----------------------------------------------------------------------------
template <class Iter_t, class Compare = std::less< value_iter<Iter_t> > >
Iter_t is_reverse_stable_sorted_forward (Iter_t first, Iter_t last,
		                                 Compare comp = Compare())
{
	assert ( (last- first) >= 0);
	if ( (last - first) < 2 ) return first;
...
//-----------------------------------------------------------------------------
template <class Iter_t, class Compare = std::less< value_iter<Iter_t> > >
Iter_t is_stable_sorted_backward (Iter_t first, Iter_t last,
		                          Compare comp = Compare())
{
	assert ( (last- first) >= 0);
	if ( (last - first) < 2 ) return first;
...
//-----------------------------------------------------------------------------
template <class Iter_t, class Compare = std::less< value_iter<Iter_t> > >
Iter_t is_reverse_stable_sorted_backward (Iter_t first, Iter_t last,
		                                  Compare comp = Compare())
{
	assert ( (last- first) >= 0);
	if ( (last - first) < 2 ) return first;
...
void internal_sort (const range< Iter1_t > &rng1,
                    const range< Iter2_t > &rng2, Compare comp,
                    uint32_t level, bool even = true)
{
    //-----------------------------------------------------------------------
    //                  metaprogram
    //-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
template < class Iter1_t, class Iter2_t, class Compare >
void range_sort_data (const range< Iter1_t > & rng_data,
...
//-----------------------------------------------------------------------------
template < class Iter1_t, class Iter2_t, class Compare >
void range_sort_buffer (const range< Iter1_t > & rng_data,
                      const range< Iter2_t > & rng_aux, Compare comp)
{
    //-----------------------------------------------------------------------
    //                  metaprogram
