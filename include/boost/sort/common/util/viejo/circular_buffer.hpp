...
struct circular_buffer
{
	...
	//                          VARIABLES
	//------------------------------------------------------------------------
	static const size_t NMAX = (size_t)1 << Power2;
	static const size_t MASK = (NMAX -1);
	static const size_t BLOCK_SIZE = NMAX >> 1;
	static const size_t LOG_BLOCK = Power2 - 1;
	Value_t * ptr  = nullptr;
