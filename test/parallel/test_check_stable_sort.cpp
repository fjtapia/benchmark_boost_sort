...
/// @brief test program of the spin_sort algorithm
///
...
using boost::sort::parallel::detail::check_stable_sort;
using boost::sort::parallel::detail::range_sort;
using boost::sort::parallel::detail::sort_range_sort;
...
void test1 ( )
{
    ...
    sort_range_sort (R2, RAux, compare ( ));
    ...
    //----------------------------------------------------------------------
    // Range of 64, randomly filled , level 2
    //---------------------------------------------------------------------
    V1.clear ( );
    V2.clear ( );
    V3.clear ( );
